...
require("lazy").setup({
  ...
  spec = {
        ...
        require('nvim-treesitter.configs').setup {
          ...
          incremental_selection = {
            ...
            keymaps = {
              ...
              scope_incremental = '<c-s>', -- Select scope (not commonly used)
    ...
    { 'tpope/vim-fugitive', event = "VeryLazy", cmd = "Git" }, -- Load on command or later
    {
      ...
      config = function()
        -- Ensure Signify is enabled when the plugin loads and a buffer is entered
        vim.cmd([[
          augroup signify_auto_enable
            autocmd!
            autocmd BufEnter * SignifyEnable
          augroup END
        ]])
      end,
    },
